...
**⚠️ Note:** *Before installing the dependencies and building the project, it is recommended to delete the tests folder because the current tests are failing and would cause the process to break.*
